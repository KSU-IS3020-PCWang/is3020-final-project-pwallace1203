...
- [x ] My application includes approximately 5–10 meaningful functions.
- [x ] My application uses a list, dictionary, tuple, or another appropriate basic collection.
- [x ] My application uses conditionals and loops.
- [ x] My application reads from or writes to a CSV or JSON file.
- [ x] My application uses realistic input validation and `try/except` error handling.
